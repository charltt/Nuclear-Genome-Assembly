...
#Usage:  snpsites.pl <SNP file> <pileup output file> <outfile name>               
#This code will pull those SNPs identified in cns.snp out of out.pileup           
